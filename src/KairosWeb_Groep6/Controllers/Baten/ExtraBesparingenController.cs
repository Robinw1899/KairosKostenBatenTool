...
namespace KairosWeb_Groep6.Controllers.Baten
{
    ...
    public class ExtraBesparingenController : Controller
    {
        ...
        public IActionResult VoegToe(Analyse analyse, ExtraBesparingViewModel model)
        {
            ...
            {
                _exceptionLogRepository.Add(new ExceptionLog(e, "ExtraBesparingen", "VoegToe -- POST --"));
        ...
        {// id is het id van de baat die moet bewerkt wordens
            ...
            {
                _exceptionLogRepository.Add(new ExceptionLog(e, "ExtraBesparingen", "Bewerk -- GET --"));
                _exceptionLogRepository.Save();
