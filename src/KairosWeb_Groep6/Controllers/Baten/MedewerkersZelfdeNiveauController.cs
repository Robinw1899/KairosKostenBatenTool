    ...
    public class MedewerkersZelfdeNiveauController : Controller
    {
        ...
        public IActionResult VoegToe(Analyse analyse, MedewerkerNiveauBaatViewModel model)
        {
            ...
            catch (Exception e)
            {
                ...
                {
                    _exceptionLogRepository.Add(new ExceptionLog(e, "MedewerkersZelfdeNiveau", "VoegToe -- POST --"));
        ...
        {// id is het id van de baat die moet bewerkt wordens
            ...
            catch (Exception e)
            {
                ...
                {
                    _exceptionLogRepository.Add(new ExceptionLog(e, "MedewerkersZelfdeNiveau", "Bewerk -- GET --"));
                    _exceptionLogRepository.Save();
                    TempData["error"] = Meldingen.OpslaanFoutmeldingKost;
                    return RedirectToAction("Index");
                }
        ...
        {// id is het id van de baat die moet bewerkt worden
            ...
            catch (Exception e)
            {
                ...
                {
                    _exceptionLogRepository.Add(new ExceptionLog(e, "MedewerkersZelfdeNiveau", "Bewerk -- POST --"));
                    _exceptionLogRepository.Save();
                    TempData["error"] = Meldingen.OpslaanFoutmeldingKost;
                    return RedirectToAction("Index");
                }
        ...
        {// id is het id van de baat die moet verwijderd worden
            ...
            {
                _exceptionLogRepository.Add(new ExceptionLog(e, "MedewerkersZelfdeNiveau", "Verwijder"));
                _exceptionLogRepository.Save();
