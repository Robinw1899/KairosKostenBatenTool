...
{
    public class KostenBatenAnalyse
    {
        /// <summary>
		...
		public static string RunSample3(DirectoryInfo outputDir, string connectionString)
        {
            ...
            FileInfo newFile = new FileInfo(outputDir.FullName + @"\Analyse.xlsx");
            ...
            using (ExcelPackage xlPackage = new ExcelPackage(newFile))
            {
                ...
                ExcelWorksheet worksheet = xlPackage.Workbook.Worksheets.Add("Kosten-Baten");
