...
{
    public class PropereCodeAnalyseResultaat
    {
        private Dictionary<Soort, string> tabelBedragen;
        public void DictionaryLocatieCellen()
        {
        ...
        //template mag er eventueel uit, we kunnen de tabel zelf maken indien we de template er niet in krijgen
        public void MaakTabelResultaat(FileInfo template, DirectoryInfo outputdir)
        {
        ...
        public void VulBatenIn(Analyse analyse, AnalyseRepository analyseRepo, ExcelWorksheet ws)
        {   //repo nodig om een analyse op te halen met een bepaald id, zo kunnen we aan de totalen van de baten en kosten
        ...
        public void VulKostenIn(Analyse analyse, AnalyseRepository analyseRepo, ExcelWorksheet ws)
        {   //repo nodig om een analyse op te halen met een bepaald id, zo kunnen we aan de totalen van de baten en kosten
