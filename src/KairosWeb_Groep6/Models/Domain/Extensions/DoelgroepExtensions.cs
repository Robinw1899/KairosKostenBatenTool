...
namespace KairosWeb_Groep6.Models.Domain.Extensions
{
    public static class DoelgroepExtensions
    {
        public static double BerekenDoelgroepVermindering(this Doelgroep doelgroep, double brutoloon,
                                                        double aantalUrenPerWeek, int aantalWerkuren, int patronaleBijdrage)
        {
        ...
        private static void ControleerGegevensOntbreken(double brutoloon, double aantalUrenPerWeek, int aantalWerkuren, int patronaleBijdrage)
        {
            if (aantalWerkuren == 0)
            {
