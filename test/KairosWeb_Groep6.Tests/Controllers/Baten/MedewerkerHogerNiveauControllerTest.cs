...
namespace KairosWeb_Groep6.Tests.Controllers.Baten
{
    public class MedewerkerHogerNiveauControllerTest
    {
        ...
        public MedewerkerHogerNiveauControllerTest()
        {
            ...
            _controller = new MedewerkersHogerNiveauController(_analyseRepo.Object);
        ...
        [Fact]
        public void TestVoegToe_ModelError_ReturnsToIndexWithModel()//assert.equal failure
        {
        ...
        [Fact]
        public void TestBewerk_Succes_RedirectsToIndex()//geeft een assert.Equal() failure, verwacht Index, krijgt null
        {
