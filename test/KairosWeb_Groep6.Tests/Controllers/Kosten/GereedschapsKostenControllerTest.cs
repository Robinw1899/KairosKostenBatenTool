...
namespace KairosWeb_Groep6.Tests.Controllers.Kosten
{
    public class GereedschapsKostenControllerTest
    {
        ...
        public GereedschapsKostenControllerTest()
        {
            ...
            _controller = new GereedschapsKostenController(_analyseRepository.Object, _exceptionLogRepository.Object);
        ...
        {
            _analyseRepository.Setup(r => r.Save()).Throws(new Exception());
            GereedschapsKostViewModel model = new GereedschapsKostViewModel{Id = 1};
