...
namespace KairosWeb_Groep6.Tests.Models.Domain.Extensions
{
    public class DoelgroepExtensionsTest
    {
        ...
        public void TestBerekenDoelgroepVermindering_GegevensOntbreken()
        {
            ...
            DoelgroepSoort doelgroep = DoelgroepSoort.LaaggeschooldTot25;
        ...
        public void TestBerekenDoelgroepVermindering_LaaggeschooldTot25_BrutoloonKleinerDanMinBrutoloon
            (int werkuren, DoelgroepSoort doelgroep, decimal brutoloon, decimal urenPerWeek, decimal expected)
        {
        ...
        #region Andere
        [Theory]
        [InlineData(37, DoelgroepSoort.Andere, 1865, 37, 0)]
        [InlineData(37, DoelgroepSoort.Andere, 2500, 23, 0)]
        [InlineData(37, DoelgroepSoort.Andere, 4466.66, 35, 0)]
        ...
        [InlineData(null, "")]
        public void TestGeefOmschrijving(DoelgroepSoort? doelgroep, string expected)
        {
            string omschrijving = DoelgroepSoortExtensions.GeefOmschrijving(doelgroep);
        ...
        [Theory]
        [InlineData(DoelgroepSoort.LaaggeschooldTot25, 2500)]
        [InlineData(DoelgroepSoort.MiddengeschooldTot25, 2500)]
        [InlineData(DoelgroepSoort.Tussen55En60, 4466.66)]
        [InlineData(DoelgroepSoort.Vanaf60, 4466.66)]
        [InlineData(DoelgroepSoort.Andere, 0)]
        [InlineData(null, 0)]
        public void TestGetMinBrutoLoon(DoelgroepSoort doelgroep, decimal expected)
        {
            decimal minBrutoLoon = DoelgroepSoortExtensions.GetMinBrutoLoon(doelgroep);
