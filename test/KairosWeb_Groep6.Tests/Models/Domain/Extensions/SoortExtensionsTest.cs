...
namespace KairosWeb_Groep6.Tests.Models.Domain.Extensions
{
    public class SoortExtensionsTest
    {
        ...
        [InlineData(Soort.PersoneelsKost, "Extra kosten werkkleding e.a. personeelskosten")]
        ...
        [InlineData(Soort.PersoneelsKost, "Welke extra kosten moet u structureel extra maken voor deze inhuur? (alleen kosten zoals werkkleding bij normale inhuur en bij reshoring alle kosten)")]
